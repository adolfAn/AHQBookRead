...
class DZMReadMenu: NSObject,UIGestureRecognizerDelegate {
    ...
    /// LightButton 宽高
    private let lightButtonWH:CGFloat = 70
    ...
    /// 点击这些控件不需要执行手势
    private let ClassString:[String] = ["ASValueTrackingSlider","UITableViewCellContentView","UISlider","AHQBookRead.DZMRMLeftView","AHQBookRead.DZMRMTopView","AHQBookRead.DZMRMBottomView","AHQBookRead.DZMHaloButton","AHQBookRead.DZMRMLightView","AHQBookRead.DZMRMColorView","AHQBookRead.DZMRMFuncView","AHQBookRead.DZMSettingView","UIButton"]
    ...
    private func initLightButton() {
        ...
        lightButton = DZMHaloButton(CGRect(x: ScreenWidth - lightButtonWH - DZMSpace_1, y: ScreenHeight, width: lightButtonWH, height: lightButtonWH), haloColor:DZMColor_2.withAlphaComponent(0.75))
    ...
    private func initTopView() {
        ...
        topView.setTitle(vc.readModel.readRecordModel.readChapterModel?.name)
