...
/// 背景颜色数组
let DZMReadBGColors:[UIColor] = [DZMReadBGColor_DAY,DZMReadBGColor_BY_FRESH,DZMReadBGColor_EYE,DZMReadBGColor_YELLOW]

/// 根据背景颜色 对应的文字颜色 数组(数量必须与 DZMReadBGColors 相同)
let DZMReadTextColors:[UIColor] = [DZMReadTextColor_DAY,DZMReadTextColor_BY_FRESH,DZMReadTextColor_EYE,DZMReadTextColor_YELLOW]

/// 根据背景颜色 对应的文字颜色 数组(数量必须与 DZMReadBGColors and DZMReadTextColors 相同)
let DZMReadHeaderAndFooterTextColors:[UIColor] = [DZMReadHeaderAndFooterTextColor_DAY,DZMReadHeaderAndFooterTextColor_BY_FRESH,DZMReadHeaderAndFooterTextColor_EYE,DZMReadHeaderAndFooterTextColor_YELLOW]
...
class DZMReadConfigure: NSObject {
    ...
    func readColor() ->UIColor {
        ...
        if colorIndex == DZMReadBGColors.index(of: DZMReadBGColor_DAY) { // 牛皮黄
    ...
    /// 获得阅读页头部和底部文字颜色
    func readHeaderAndFooterColor() ->UIColor {
        
        return DZMReadHeaderAndFooterTextColors[colorIndex]
    }
